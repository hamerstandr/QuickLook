...
namespace QuickLook.Common.Helpers
{
    public class FileHelper
    {
        ...
        public static BitmapImage OpenImage(string Name,object view)
        {
            System.IO.Stream aPngFileStream = view.GetType().Assembly.GetManifestResourceStream("pack://application:,,,/" + Name);
            BitmapImage imgSource = new BitmapImage(new Uri("pack://application:,,,/"+Name));
